...
/**
 * Represents an in-game notification with a title, message text, and optional
 * color.
 * <p>
...
public class Notification {
    /**
     * Sentinel value indicating no custom color should be used for the
     * notification.
     */
     ...
     * @param color The RGB color value for the notification, or {@link #NO_COLOR}
     *              for default color
     */
    ...
    /**
     * @return An Optional containing the color if set, or empty if using default
     *         color
     */
